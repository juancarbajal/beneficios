...
class OfertaPuntos
{
    ...
    public function exchangeArray($data)
    {
        ...
        $this->CondicionesDeliveryTexto = (!empty($data['CondicionesDeliveryTexto'])) ? $data['CondicionesDeliveryTexto'] : null;
        $this->CondicionesDeliveryEstado = (!empty($data['CondicionesDeliveryEstado'])) ? $data['CondicionesDeliveryEstado'] : null;
        $this->CorreoContactoDelivery = (!empty($data['CorreoContactoDelivery'])) ? $data['CorreoContactoDelivery'] : null;
    }
