...
class CuponPremiosLog
{
    public $id;
    public $BNF3_Cupon_Premios_id;
    public $CodigoCupon;
    public $EstadoCupon;
    ...
    public function exchangeArray($data)
    {
        ...
        $this->BNF3_Cupon_Premios_id = (!empty($data['BNF3_Cupon_Premios_id'])) ? $data['BNF3_Cupon_Premios_id'] : null;
        ...
        $this->BNF3_Oferta_Premios_Atributos_id =
            (!empty($data['BNF3_Oferta_Premios_Atributos_id'])) ? $data['BNF3_Oferta_Premios_Atributos_id'] : null;
