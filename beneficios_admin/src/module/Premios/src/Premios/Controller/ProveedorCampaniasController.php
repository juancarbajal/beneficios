...
use Premios\Form\FormReporteProveedorCampanias;
    ...
    public function exportAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $objPHPExcel->getProperties()
                ...
                ->setTitle("Reporte de Proveedor Campañas Premios")
                ->setSubject("Reporte Proveedor Campañas Premios")
                ->setDescription("Documento Reporte de Proveedor Campañas Premios")
                ->setKeywords("Beneficios.pe")
                ->setCategory("Reporte Proveedor Campañas Premios");
            ...
            $resultado = $this->getOfertaPremiosTable()
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A1', 'Reporte proveedor campañas Premios')
                ->mergeCells('A1:B1')
            ...
            header('Content-Disposition: attachment;filename="ReporteProveedorCampañasPremios.xlsx"');
