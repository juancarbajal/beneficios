...
use Premios\Form\FormReporteIngresosGlobales;
    ...
    public function exportAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $objPHPExcel->getProperties()
                ...
                ->setTitle("Reporte de Ingresos Globales Premios")
                ->setSubject("Reporte Ingresos Globales Premios")
                ->setDescription("Documento Reporte de Ingresos Globales Premios")
                ->setKeywords("Beneficios.pe")
                ->setCategory("Reporte Ingresos Globales Premios");
            ...
            $resultado = $this->getOfertaPremiosTable()->getByEmpresaOrCampaniaOrRango(
                (int)$data['empresa'],
                (int)$data['campania'],
                $data['FechaInicio'],
                $data['FechaFin']
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A1', 'Reporte de ingresos globales Premios')
                ->mergeCells('A1:B1')
            ...
            header('Content-Disposition: attachment;filename="IngresosGlobalesPremios.xlsx"');
