...
use Premios\Form\FormReporteOfertasTop;
...
class OfertasTopController extends AbstractActionController
{
    ...
    public function exportAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $resultado = $this->getOfertaPremiosTable()->getByEmpresaOrCampaniaOrSegmento(
                (int)$data['empresa'],
                (int)$data['campania'],
                (int)$data['segmento'],
                $data['estado']
            ...
            $segmento = $this->getSegmentoPremiosTable()->getSegmentosPremios((int)$data['segmento']);
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ->setCellValue('A1', 'Reporte top ofertas premios')
                ->mergeCells('A1:B1')
