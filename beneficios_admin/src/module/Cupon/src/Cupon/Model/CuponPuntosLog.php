...
class CuponPuntosLog
{
    ...
    public $Comentario;
    public  $comentario_uno;
    public  $comentario_dos;
    ...
    public function exchangeArray($data)
    {
        ...
        $this->comentario_uno = (!empty($data['comentario_uno'])) ? $data['comentario_uno'] : null;

        $this->comentario_dos = (!empty($data['comentario_dos'])) ? $data['comentario_dos'] : null;
