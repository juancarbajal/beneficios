...
use Puntos\Form\FormReportePuntos;
use Zend\Json\Json;
...
class ReportePuntosController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $form = new FormReportePuntos('reporte', $data[0], $type);
        ...
        if ($request->isPost()) {
            ...
            if ($checkbox_demo && !$checkbox_comp && !$checkbox_pref) {
                ...
                if ($checkbox_empresa || $checkbox_campania || $checkbox_segmento || $checkbox_usuario) {
                    #region Opciones
                    $datosEmpresa = $this->getEmpresaTable()->getEmpresa($empresa);
                    $datosCampania = $this->getCampaniaPuntosTable()->getCampaniasP($campania);
                    $datosSegmento = $this->getSegmentoPuntosTable()->getSegmentosP($segmento);
                ...
                if ($checkbox_empresa || $checkbox_campania || $checkbox_segmento || $checkbox_usuario) {
                    ...
                    #region Seccion Empresa
                    $objPHPExcel->setActiveSheetIndex(0)
                        ->setCellValue('A6', 'Puntos aplicados por rubros')
                        ->mergeCells('A6:I6')
                        ->setCellValue('J6', 'Puntos redimidos por rubros')
                        ->mergeCells('J6:R6');
                    ...
                    if ($checkbox_campania or $checkbox_segmento or $checkbox_usuario) {
                        ...
                        $objPHPExcel->setActiveSheetIndex(0)
                            ->setCellValue('B' . $i, 'Campañas')
                            ->mergeCells('B' . $i . ':B' . ($i + 1))
                            ->setCellValue('C' . $i, 'Puntos aplicados por rubros')
                            ->mergeCells('C' . $i . ':K' . $i)
                            ->setCellValue('L' . $i, 'Puntos redimidos por rubros')
                            ->mergeCells('L' . $i . ':T' . $i);
                    ...
                    if ($checkbox_segmento or $checkbox_usuario) {
                        ...
                        $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->mergeCells('C' . $i . ':C' . ($i + 1))
                            ->setCellValue('D' . $i, 'Puntos aplicados por rubros')
                            ->mergeCells('D' . $i . ':L' . $i)
                            ->setCellValue('M' . $i, 'Puntos redimidos por rubros')
                            ->mergeCells('M' . $i . ':U' . $i);
                    ...
                    if ($checkbox_usuario) {
                        ...
                        $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('E' . $i, 'Puntos aplicados por rubros')
                            ->mergeCells('E' . $i . ':M' . $i)
                            ->setCellValue('N' . $i, 'Puntos redimidos por rubros')
                            ->mergeCells('N' . $i . ':V' . $i);
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                        ...
                        ->mergeCells('A6:A7')
                        ->setCellValue('B6', 'Puntos aplicados por rubros')
                        ->mergeCells('B6:J6')
                        ->setCellValue('K6', 'Puntos redimidos por rubros')
                        ->mergeCells('K6:Q6');
                ...
                if ($checkbox_empresa || $checkbox_campania || $checkbox_segmento || $checkbox_usuario) {
                    ...
                    if (!$checkbox_usuario) {
                        ...
                        $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->mergeCells('B6:D6')
                            ->setCellValue('E6', 'Puntos')
                            ->mergeCells('E6:H6')
                            ->setCellValue('I6', 'Puntos en Rubros aplicados')
                            ->mergeCells('I6:Q6')
                    ...
                    if (($checkbox_campania and !$checkbox_usuario) or ($checkbox_segmento and !$checkbox_usuario)) {
                        ...
                        $objPHPExcel->setActiveSheetIndex(0)
                            ->setCellValue('J' . $i, 'Puntos aplicados por rubros')
                            ->mergeCells('J' . $i . ':R' . $i)
                            ->setCellValue('S' . $i, 'Puntos redimidos por rubros')
                            ->mergeCells('S' . $i . ':AA' . $i);
                    ...
                    if ($checkbox_segmento and !$checkbox_usuario) {
                        ...
                        $objPHPExcel->setActiveSheetIndex(0)
                            ->setCellValue('K' . $i, 'Puntos aplicados por rubros')
                            ->mergeCells('K' . $i . ':S' . $i)
                            ->setCellValue('T' . $i, 'Puntos redimidos por rubros')
                            ->mergeCells('T' . $i . ':AB' . $i);
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('N7', 'Distritos')
                    ->setCellValue('O7', 'Lugar de Trabajo')
                    ->setCellValue('P6', 'Puntos aplicados por rubros')
                    ->mergeCells('P6:W6')
                    ->setCellValue('Y6', 'Puntos redimidos por rubros')
                    ->mergeCells('Y6:AG6')
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('T6', 'Puntos aplicados por rubros')
                    ->mergeCells('T6:AB6')
                    ->setCellValue('AC6', 'Puntos redimidos por rubros')
                    ->mergeCells('AC6:AK6')
