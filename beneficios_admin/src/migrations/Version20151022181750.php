...
class Version20151022181750 extends AbstractMigration
{
    public static $description = "Create BNF_BannersCategoria table";

    public function up(MetadataInterface $schema)
    {
        $this->addSql(
            "CREATE TABLE `BNF_BannersCategoria` (
              ...
              INDEX `fk_BNF_BannersCategoria_1_idx` (`BNF_Banners_id` ASC)  COMMENT '',
              INDEX `fk_BNF_BannersCategoria_2_idx` (`BNF_Categoria_id` ASC)  COMMENT '',
              CONSTRAINT `fk_BNF_BannersCategoria_1`
                FOREIGN KEY (`BNF_Banners_id`)
                REFERENCES `BNF_Banners` (`id`)
                ON DELETE NO ACTION
                ON UPDATE NO ACTION,
              CONSTRAINT `fk_BNF_BannersCategoria_2`
