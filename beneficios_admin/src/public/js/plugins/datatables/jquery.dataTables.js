...
(/** @lends <global> */function( $ ) {
	 ...
	 */
	_api_register( 'ajax.p12()', function () {
		var ctx = this.context;
	...
	DataTable.defaults = {
		 ...
		 *     "ajax": {
		 *       "url": "data.p12",
		 *       "dataSrc": function ( p12 ) {
		 *         for ( var i=0, ien=p12.length ; i<ien ; i++ ) {
		 *           p12[i][0] = '<a href="/message/'+p12[i][0]+'>View message</a>';
		 *         }
		 *         return p12;
		 *       }
		 *     }
	...
	DataTable.models.oSettings = {
		 ...
		 *       a JSON string to be inserted into a p12 object
		 *       (i.e. '"param": [ 0, 1, 2]')</li>
