...
$(document).ready(function () {
    ...
    $('#empresa-cli').change(function () {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '/ofertas-puntos/getDataEmpresa',
    ...
    $('#campanias').change(function () {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '/ofertas-puntos/getDataSegmentos',
    ...
    $('#pais').on('change', null, function (event, value) {
        ...
        $.post("/ofertas-puntos/getDepartamentos", {
            id: get_val
        }, function (data) {
    ...
    $('.delete-image').click(function () {
        ...
        if (confirm('!La imagen se eliminara inmediatamente¡. ¿esta seguro de seguir?')) {
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: '/ofertas-puntos/deleteImagen',
                data: {id: id},
                success: function (data) {
                    if (data.response) {
    ...
    $('input[name=principal]').on('click', function () {
        ...
        if ($('input[name=principal]').is(':checked')) {
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: '/ofertas-puntos/principalImage',
...
function deleteFields(e) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: '/ofertas-puntos/getDescargasByAtributo',
        data: {
...
function createPrecioFields(option) {
    ...
    var contenido = '<div class="col-md-2"><textarea title="Atributo" class="form-control atributos" name="atributos[' + count + ']" onkeypress="caracteresRestantes(this)"></textarea>' +
        ...
        '<div class="col-md-2">' +
        '<button class="addfields btn btn-default" type="button" onclick="createPrecioFields(treu)">&#43;</button>' +
...
function listImage(name) {
    ...
    cell1.innerHTML = '<a id="single_image" href="/elements/oferta_puntos/' + name + '"><img style="height: 50px;width: '
        + '50px;" src="/elements/oferta_puntos/' + name + '"></a>';
...
function deleteImage(index, name) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: '/ofertas-puntos/deleteImage',
        data: {
            val: name,
            ext: fileExtension
        },
